#!/usr/bin/env python3
"""
Enhanced Moonbeam DelegateVotesChanged Event Indexer
...
# Configuration for Moonbeam DelegateVotesChanged
MOONBEAM_RPC_URL = "https://moonbeam.api.onfinality.io/public"
...
CHECKPOINT_FILE = "moonbeam_delegatevotes_checkpoint.pkl"
PROGRESS_FILE = "moonbeam_delegatevotes_progress.txt"
...
class EnhancedDelegateVotesIndexer:
    def __init__(self):
        ...
        self.csv_filename = f"Moonbeam_DelegateVotesChanged_events_{timestamp}.csv"
    ...
    def run_indexer(self):
        ...
        print(f"🚀 Starting Moonbeam DelegateVotesChanged indexer...")
